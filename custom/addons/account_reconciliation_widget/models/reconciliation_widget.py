...
class AccountReconciliation(models.AbstractModel):
    ...
    def get_move_lines_for_bank_statement_line(
        ...
        date_sup = " account_move_line.date_maturity > '2021-12-31'" #Add By L
        query_str = sql.SQL(
            """
        ...
        """.format(
                ...
                #where_str=where_clause and (" WHERE %s" % where_clause) or "", #COM By L
                where_str=where_clause and (" WHERE %s and %s" % (where_clause, date_sup)) or "",   #Ed By L
