...
class Picking(models.Model):
    ...
    def button_validate(self):
        ...
        if not self._should_show_transfers():
            ...
            #if pickings_without_quantities: #CMT By L
                #raise UserError(self._get_without_quantities_error_message()) #CMT BY L
    ...
    def _pre_action_done_hook(self):
        ...
        #CMT BY L : To allow creation of backorder automatically without the wizard for user to choose
